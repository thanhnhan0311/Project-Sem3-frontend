...
import { UpdateEmployeeRequest } from "../../api/employeeApi";
...
export default function UpdateEmployeePopUp({ action, employee }) {
  ...
  const onUpdateProduct = () => {
    ...
    updateEmployeeRequest.mutate(formData, {
      onSuccess: (response) => {
  ...
  return (
    <StyledPopUp action={() => {}}>
              ...
              <img
                ...
                src={
                  typeof avatar == "string"
                    ? import.meta.env.VITE_API_IMAGE_PATH + avatar
      ...
      <Footer>
        <button onClick={onUpdateProduct}>Confirm</button>
