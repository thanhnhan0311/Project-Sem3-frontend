...
const Container = styled.div`
  ...
  .embla__viewport_best {
    overflow: hidden;
  }
  .embla__container_best {
  ...
  .embla__slide__number_best {
    font-weight: 600;
    height: 100%;
  }
  .embla__controls_best {
    position: absolute;
    width: 100%;
    top: 0;
    margin: auto;
...
const BestSellerProduct = (props) => {
  ...
  return (
    <Container>
      <section className="embla_best">
        <div className="embla__controls_best">
          <div className="embla__buttons_best">
            <PrevButton onClick={onPrevButtonClick} disabled={prevBtnDisabled} />
            <NextButton onClick={onNextButtonClick} disabled={nextBtnDisabled} />
          </div>
        </div>

        <div className="embla__viewport_best" ref={emblaRef}>
          <div className="embla__container_best">
            {SLIDES.map((item, index) => (
              <div className="embla__slide_best" key={index}>
                <div className="embla__slide__number_best">
                  <ItemContainer>
                    {data
                      .filter((_, number) => number < (index + 1) * 5 && number >= 5 * index)
                      .map((item, index) => {
...
function PrevButton(props) {
  ...
  return (
    <button className="embla__button_best embla__button--prev_best" type="button" {...restProps}>
...
function NextButton(props) {
  ...
  return (
    <button className="embla__button embla__button--next_best" type="button" {...restProps}>
      <svg className="embla__button__svg_best" viewBox="0 0 532 532">
        <path
          fill="currentColor"
